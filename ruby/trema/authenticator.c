...
static VALUE
authenticate_mac( VALUE self, VALUE mac ) {
  UNUSED( self );
...
static VALUE
init_authenticator_ruby( VALUE self, VALUE file ) {
 UNUSED( self );
...
void
Init_authenticator() {
  cAuthenticator = rb_define_class_under( mTrema, "Authenticator", rb_cObject );
  rb_define_singleton_method( cAuthenticator, "authenticate_mac", authenticate_mac, 1 );
  rb_define_singleton_method( cAuthenticator, "init_authenticator", init_authenticator_ruby, 1 );
}
