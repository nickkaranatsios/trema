...
jedex_value_iface *jedex_value_boolean_class( void );
jedex_value_iface *jedex_value_bytes_class( void );
jedex_value_iface *jedex_value_double_class( void );
jedex_value_iface *jedex_value_float_class( void );
jedex_value_iface *jedex_value_int_class( void );
jedex_value_iface *jedex_value_long_class( void );
jedex_value_iface *jedex_value_null_class( void );
jedex_value_iface *jedex_value_string_class( void );
